...
data_file = "Japanese_sample.json"
data_file_path = "./data/raw/PromiseEval_Sample_Trainset_Japanese.json"
output_file_path = "./data/processed/statistics/Japanese_sample_statistics.json"
