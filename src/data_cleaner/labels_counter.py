...
data_file = "French_sample.json"
data_file_path = "./data/raw/PromiseEval_Sample_Trainset_French.json"
output_file_path = "./data/processed/statistics/French_sample_statistics.json"
