...
# 3つのJSONファイルのパスを指定
data_file = "All Korean data"
test_file_path = "./data/processed/statistics/Korean_test_statistics.json"
train_file_path = "./data/processed/statistics/Korean_train_statistics.json"
output_file_path = "./data/processed/statistics/Korean_all_statistics.json"  # 出力する総和のJSONファイルのパス
