...
# 3つのJSONファイルのパスを指定
data_file = "All English data"
sample_file_path = "./data/processed/statistics/English_sample_statistics.json"
test_file_path = "./data/processed/statistics/English_test_statistics.json"
train_file_path = "./data/processed/statistics/English_train_statistics.json"
output_file_path = "./data/processed/statistics/English_all_statistics.json"  # 出力する総和のJSONファイルのパス
