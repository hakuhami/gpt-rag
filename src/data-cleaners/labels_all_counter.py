...
# 3つのJSONファイルのパスを指定
data_file = "All Chinese data"
sample_file_path = "./data/processed/statistics/Chinese_sample_statistics.json"
test_file_path = "./data/processed/statistics/Chinese_test_statistics.json"
train_file_path = "./data/processed/statistics/Chinese_train_statistics.json"
output_file_path = "./data/processed/statistics/Chinese_all_statistics.json"  # 出力する総和のJSONファイルのパス
