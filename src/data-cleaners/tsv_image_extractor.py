...
def process_tsv_and_add_to_excel(wb, tsv_path, pdf_dir, sheet_name):
    ...
    # 画像列の幅を設定
    ws.column_dimensions[img_col].width = 100  # 適切な幅に調整
...
if __name__ == "__main__":
    input_dir = "./data/processed/statistics/non-coresspond/Chinese_withoutRAG"
    pdf_dir = "./data/raw/PDFs"
    output_excel_path = "./data/processed/statistics/non-coresspond/Chinese_withoutRAG_analysis.xlsx"
