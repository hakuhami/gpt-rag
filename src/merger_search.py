...
# 結合するJSONファイルのパスを指定
json_file_1 = './data/processed/Chinese_sample_extracted.json'
json_file_2 = './data/processed/Chinese_train_extracted.json'
output_file = './data/processed/Chinese_search_extracted.json'
