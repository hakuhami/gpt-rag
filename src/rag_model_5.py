# "explain"付きのデータを検索対象とした場合（プロンプトもそれに合わせて微修正）（search_data_path: "data/processed/Japanese_train_experiment_explanained.json”とする！）
...
class RAGModel:
    ...
    def analyze_paragraph(self, paragraph: str) -> Dict[str, str]:
        ...
        In addition to the labels specified in the json format below, the reference examples have an "explanation" label that explains the extraction and classification features.
